<template>
  <div class="music-list">
    ...
    <scroll class="list" :data="songs" ref="list" @scroll="scroll" :probeType="probeType" :listenScroll="listenScroll">
...
export default {
  ...
  mounted () {
    ...
    this.minTranslateHeight = -this.imageHeight + this.titleHeight
